...
export default function Searchbar() {
  ...
  return (
    <div className="bg-slate-200 py-10">
      ...
      <form class="relative border border-gray-200 rounded-lg w-full max-w-lg mx-auto" onSubmit={handleSubmit}>
        <input type="text" class="rounded-md p-3 w-full" placeholder="고해상도 이미지 검색" value={text} onChange={onChange} />
